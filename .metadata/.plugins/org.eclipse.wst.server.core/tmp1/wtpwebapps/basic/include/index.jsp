        ...
        <div class="navbar-solid-state">
            ...
            <nav id="menu">
                <div class="inner">
                    <h2>Menu</h2>
                    <ul class="links">
                        <li><a href="<%@ include file="include/index.jsp" %>">Home</a></li>
                        <li><a href="<%@ include file="include/element.jsp" %>">Elements</a></li>
        ...
        <section id="footer">
            <div class="container">
                ...
                <div class="footer-bottom">
                    <div class="row">
                        <div class="col-md-12">
                            <p>TECHNEXT 2016. ALL RIGHTS RESERVED BY <a href="http://www.themewagon.com" target="_blank">THEMEWAGON</a></p>
                        </div>
                    </div>
                </div>
            </div>
